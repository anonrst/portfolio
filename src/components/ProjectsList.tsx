...
const ProjectsList = () => {
  return (
    <section className="px-4 sm:px-6 md:px-16 lg:px-24 py-8 sm:py-12">
      ...
      >
        <h2 className="text-xs sm:text-sm font-mono text-muted-foreground mb-4 sm:mb-6">projects</h2>
        <div className="space-y-0 overflow-hidden">
          {projects.map((project, i) => (
            ...
            >
              ...
              <div className="flex flex-wrap gap-1.5 sm:gap-2 sm:ml-4 flex-shrink-0 max-w-full sm:max-w-[40%]">
                {project.tech.map((t) => (
                  <span
                    key={t}
